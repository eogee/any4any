...
class Config:
    ...
    INDEX_TTS_FAST_BATCH_SIZE = int(os.getenv("INDEX_TTS_FAST_BATCH_SIZE", "16"))   # 快速模式：分句分桶的最大容量（越大越快，默认16）
    INDEX_TTS_STREAMING_MIN_SENTENCE_CHARS = int(os.getenv("INDEX_TTS_STREAMING_MIN_SENTENCE_CHARS", "15"))  # 流式模式最小句子字符数（避免过度碎片化）
